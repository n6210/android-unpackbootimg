...
#define IH_TYPE_ANDROID		11	/* Android Image		*/
...
typedef struct bootm_headers {
	...
	boot_img_hdr	*android_hdr;		/* android header address copy */
...
#define	IMAGE_FORMAT_ANDROID	0x03	/* Android recovery image format */
